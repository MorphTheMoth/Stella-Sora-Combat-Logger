...
<img src="https://github.com/user-attachments/assets/cb5349ab-5f8e-4de0-a21d-9565d5ed459a" width="100%"/> <img src="https://github.com/user-attachments/assets/afb4e2e7-6a26-4d5c-a2fa-b1f30066d967" width="100%"/>
...
- Download `stellaCombatLogger.dll` and `log_viewer.exe` from the releases tab https://github.com/MorphTheMoth/Stella-Sora-Combat-Logger/releases
...
- Run the command `stellaDllInjector.exe stellaCombatLogger.dll`, then open the game
